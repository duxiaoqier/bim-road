...
(function($){
    $.fn.JNMagnifier=function(setting){
		...
		_img_org_.mouseover(function(){
			setting.renderTo.html('<img src="' + _img_org_.attr("src") + '" style="position: relative;" id="JNMagnifierrenderToImg" />');
		...
		_img_org_.mousemove(function(e){
			...
			_move_y =0-Math.round((document.documentElement.scrollTop+e.clientY-__top) * __h - _val_h)+2000;
